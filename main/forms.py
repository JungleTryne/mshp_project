...
class BaseSnippetForm(forms.Form):
    """
    Форма работы со сниппетом. Используется во view-функциях для \
        добавления и/или просмотра

    :param name: имя сниппета
    :param user: пользователь. Подставляется автоматически на \
        основе данных об авторизации
